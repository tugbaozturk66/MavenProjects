...
public class C02_YoutubeAsertion {
...
public void imageTest(){
    ...
    Assert.assertTrue("logo gorunmuyor",youtubeLogo.isDisplayed());
}
@Test
    public void searchBox(){
    WebElement searchBox= driver.findElement(By.xpath("//input[@id='search']"));
    Assert.assertTrue("arama kutusu ulasilamiyor",searchBox.isEnabled());
}
@Test
